...
public class MenuUsuario extends JFrame {
	...
	public MenuUsuario() {
		...
		JPanel btnCerrarSecion = new JPanel();
		btnCerrarSecion.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseEntered(MouseEvent e) {
				btnCerrarSecion.setBackground(new Color(118, 187, 223));				
			}
			@Override
			public void mouseExited(MouseEvent e) {
				btnCerrarSecion.setBackground(new Color(12, 138, 199));	
			}
			@Override
			public void mouseClicked(MouseEvent e) {
		...
		JLabel lblCerrarSecion = new JLabel("Cerrar sesion");
		lblCerrarSecion.setHorizontalAlignment(SwingConstants.LEFT);
		lblCerrarSecion.setForeground(Color.WHITE);
		lblCerrarSecion.setFont(new Font("Dialog", Font.PLAIN, 18));
		lblCerrarSecion.setBounds(27, 11, 200, 34);
		btnCerrarSecion.add(lblCerrarSecion);
		
		btnCerrarSecion.setLayout(null);
		btnCerrarSecion.setBackground(new Color(12, 138, 199));
		btnCerrarSecion.setBounds(0, 455, 257, 56);
		panelMenu.add(btnCerrarSecion);
